...
#include "ui_WaypointViewReadOnly.h"

WaypointViewReadOnly::WaypointViewReadOnly(Waypoint* wp, QWidget *parent) :
    QWidget(parent),
    m_ui(new Ui::WaypointViewReadOnly)
{
    m_ui->setupUi(this);
    this->wp = wp;
    updateValues();
...
void WaypointViewReadOnly::changedAutoContinue(int state)
{
...
void WaypointViewReadOnly::changedCurrent(int state)
{
    qDebug() << "Trof: WaypointViewReadOnly::changedCurrent(" << state << ") ID:" << wp->getId();
...
void WaypointViewReadOnly::setCurrent(bool state)
{
...
void WaypointViewReadOnly::updateValues()
{
    qDebug() << "Trof: WaypointViewReadOnly::updateValues() ID:" << wp->getId();
...
WaypointViewReadOnly::~WaypointViewReadOnly()
{
    delete m_ui;
}
